    ...
    <div className="creditAccount">
      <form onSubmit={handleSubmit}>
        <div class="creditAccount__input">
          ...
          <input class="uk-input uk-form-width-medium" type="number" placeholder="min. NGN100" {...getFieldProps('credit')} />
        ...
        <div className="uk-margin">
          {values.credit < 100 ? (
            ...
            <PaystackButton {...componentProps} className={`uk-button uk-button-default pay ${!errors.credit && touched['credit'] ? 'active' : ''}`} type="submit">
              Credit
            </PaystackButton>
          )}
